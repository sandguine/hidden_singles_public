...
df_puzzle %>% 
  ...
  labs(x = "Trial",
       y = "Frequency") +
  # labs(title = "Actual Incorrect Responses",
  #      x = "Trial",
  #      y = "Frequency") +
...
df_agg_p_responses %>% 
  ...
  coord_cartesian(y = c(0, 0.5)) +
  labs(x = "Trial",
       # title = "Inferred Probabilities of Incorrect Responses",
       y = "P(Response)") +
  guides(fill = guide_legend(title="Response Type")) +
  theme(legend.box.background = element_rect(colour = "black"),
        # legend.position = c(.835, .79),
        legend.position = c(.835, .81),
        text = element_text(size=15)) +
  ggsave(glue("../figures/practice_phase/p_responses_macro.png"), width=6, height=4)
```
...
df_p_responses %>% 
  ...
  theme(legend.box.background = element_rect(colour = "black"),
        ...
        legend.position = c(.835, .81),
        text = element_text(size=15)) +
  ggsave(glue("../figures/practice_phase/p_responses_micro.png"), width=6, height=4)
```
...
df_agg_p_strategies %>% 
  ...
  geom_bar(stat = "identity") + 
  labs(x = "Trial",
       # title = "Inferred Distributions of Strategies",
       y = "P(Strategy)") +
  guides(fill = guide_legend(title="Strategy")) +
  theme(legend.box.background = element_rect(colour = "black"),
        # legend.position = c(.70, .30),
        legend.position = c(.70, .28),
        text = element_text(size = 15)) +
  ggsave(glue("../figures/practice_phase/p_strategies_macro.png"), width=6, height=4)
```
...
df_p_strategies %>% 
  ...
  theme(legend.box.background = element_rect(colour = "black"),
        ...
        legend.position = c(.70, .28),
        text = element_text(size = 15)) +
  ggsave(glue("../figures/practice_phase/p_strategies_micro.png"), width=6, height=4)
```
...
df %>% 
  ...
  coord_cartesian(ylim = c(0, 1)) + 
  labs(x = 'Trial',
       # title = TeX("P(successful)"),
       y = '% of Participants') +
  guides(color = guide_legend(title="Threshold")) +
  theme(legend.box.background = element_rect(colour = "black"),
        # legend.position = c(.845, .26),
        legend.position = c(.845, .24),
        text = element_text(size = 15)) +
...
```{r}
colors2 = c(colors)
colors2[[response_names[4]]] = 'white'
...
ggsave(glue("../figures/practice_phase/paths.png"), plot=p, width=8, height=4.5)
```
